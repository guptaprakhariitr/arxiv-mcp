...
[![Live](https://img.shields.io/badge/live-arxiv-mcp.atlasword.workers.dev-brightgreen.svg)](https://arxiv-mcp.atlasword.workers.dev)
...
|---|---|---|
| `arxiv_search` | `query?, author?, category?, limit?` | Search arXiv by free-text, author, and/or category. Up to 100 results. |
| `arxiv_get_paper` | `id` | Paper metadata + abstract by id (e.g. '2024.04567' or 'arXiv:2024.04567v2'). |
| `arxiv_daily_digest` | `category, date?` | Recently-submitted papers in a category — daily catch-up. |
| `arxiv_author_graph` | `author, depth? — Team+` | Build a collaborator graph rooted at an author (depth 1 = direct co-authors). |
...
Get a key at **https://arxiv-mcp.atlasword.workers.dev/upgrade?tier=solo** (see [Getting an API key](#getting-an-api-key)).
...
- **arXiv.org API** — https://arxiv.org/help/api — *Free public-API; per arXiv terms*
...
- **Data export:** `GET https://arxiv-mcp.atlasword.workers.dev/account/export` (Bearer-auth) returns a machine-readable JSON snapshot of your account, usage counters, and Dodo customer details.
...
- **Source repo:** [https://github.com/guptaprakhariitr/arxiv-mcp](https://github.com/guptaprakhariitr/arxiv-mcp)
...
The npm package is just a launcher — it shells out to [`mcp-remote`](https://www.npmjs.com/package/mcp-remote) and points it at the hosted endpoint (`https://arxiv-mcp.atlasword.workers.dev/mcp`).
